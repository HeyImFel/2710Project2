...
int main()
{
    cout << "beginning tests. Any functions that are influenced by luck (Aaron, Bob) will instead be guaranteed passes and will not behave the same as they do outside of testing.\n\n";
    unit_testing1();
    ...
    cin.get();
    unit_testing5();
    cout << "press enter to continue to main program";
    cin.get();
...
void unit_testing1() {
    cout << "unit_testing1\nfirst bool is aaron, second is bob, third is charlie, testing method at_least_two_alive\n";
    bool aAlive = true;
    bool bAlive = true;
    bool cAlive = true;
    assert(at_least_two_alive(aAlive, bAlive, cAlive));
    cout << aAlive << " " << bAlive << " " << cAlive << " true, passed\n";
    ...
    cAlive = true;
    assert(!at_least_two_alive(aAlive, bAlive, cAlive));
    cout << aAlive << " " << bAlive << " " << cAlive << " false, passed\n";
...
void unit_testing2() {
    ...
    cout << "unit_testing2\nfirst bool is bob, second is charlie, testing method Aaron_shoots1. If a starting value for one is true in before and false in after, that is who aaron is shooting at.\nB C\n";
    
    bool bAlive = true;
    bool cAlive = true;
    cout << bAlive << " " << cAlive << " before\n";
    Aaron_shoots1(bAlive, cAlive);
    assert(!cAlive && bAlive);
    cout << bAlive << " " << cAlive << " after, test passed\n";
...
void unit_testing3() {
    guaranteeSuccess = true;
    cout << "unit_testing3\nfirst bool is aaron, second is charlie, testing method Bob_shoots. If a starting value for one is true in before and false in after, that is who bob is shooting at.\nA C\n";
    
    bool aAlive = true;
    bool cAlive = true;
    cout << aAlive << " " << cAlive << " before\n";
    Bob_shoots(aAlive, cAlive);
    assert(!cAlive && aAlive);
    cout << aAlive << " " << cAlive << " after, test passed\n";
...
void unit_testing4() {
    guaranteeSuccess = true;
    cout << "unit_testing4\nfirst bool is aaron, second is bob, testing method Charlie_shoots. If a starting value for one is true in before and false in after, that is who charlie is shooting at.\nA B\n";

    bool aAlive = true;
    bool bAlive = true;
    cout << aAlive << " " << bAlive << " before\n";
    Charlie_shoots(aAlive, bAlive);
    assert(!bAlive && aAlive);
    cout << aAlive << " " << bAlive << " after, test passed\n";
...
void unit_testing5() {
    guaranteeSuccess = true;
    cout << "unit_testing5\nfirst bool is bob, second is charlie, testing method Aaron_shoots2. If a starting value for one is true in before and false in after, that is who aaron is shooting at.\nB C\n";
    ...
    assert(cAlive && bAlive);
    cout << bAlive << " " << cAlive << " after, no change because aaron intentionally missed, test passed\n";
